...
export default function LandingPage() {
  return (
    <div style={{ background: "var(--bg)" }} className="min-h-screen overflow-hidden relative">
      {/* Watermark */}
      <img
        src="/logo.png"
        alt=""
        aria-hidden="true"
        className="pointer-events-none select-none absolute top-10 left-1/2 -translate-x-1/2 opacity-[0.05] z-0"
        style={{ width: "900px", maxWidth: "160vw" }}
      />
